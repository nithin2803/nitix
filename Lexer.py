...
class Lexer:
    ...
    def make_string(self):
        ...
        while self.current_char != None and (self.current_char != '"'or escape_character):
            if escape_character:
                character_to_escape = escape_characters.get(self.current_char, '\\' + self.current_char)
                string += character_to_escape
                escape_character = False
            else:
                if self.current_char == '\\':
        ...
        if self.current_char != '"':
            return None,  ExpectedCharError(pos_start, self.pos, "Expected \" to end string literal")
